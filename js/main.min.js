...
if (
   ...
   if (window.innerWidth > 1e3) {
       ...
       window.addEventListener("scroll", () => {
           ...
           if(t>30){
            document.querySelector('.header__bottom ').classList.add('hideHeader');
           }else{
            document.querySelector('.header__bottom ').classList.remove('hideHeader');
           }
...
document.addEventListener("click", closeAllSelect),
   ...
   // Малекьткая библиотека RGBaster, которая помогает узнать преобладающий цвет с изображения

...
if (
   ((function (e, t) {
       ...
       function y(e, t, i) {
           var n,
               o,
               s = (i = i || v).createElement("script");
           if (((s.text = e), t)) for (n in m) (o = t[n] || (t.getAttribute && t.getAttribute(n))) && s.setAttribute(n, o);
                           ...
                           (n = e[t]),
                               "__proto__" !== t &&
                                   ...
                                   (c && n && (w.isPlainObject(n) || (o = Array.isArray(n)))
                                       ? ((i = r[t]), (s = o && !Array.isArray(i) ? [] : o || w.isPlainObject(i) ? i : {}), (o = !1), (r[t] = w.extend(c, s, n)))
                                       : void 0 !== n && (r[t] = n));
               return r;
           }),
           w.extend({
               ...
               map: function (e, t, i) {
                   var n,
                       ...
                       r = 0,
                       a = [];
                   if (x(e)) for (n = e.length; r < n; r++) null != (o = t(e[r], r, i)) && a.push(o);
           ...
           (function (e) {
               ...
               function ae(e, t, n, o) {
                   ...
                   if (!o && (p(t), (t = t || h), g)) {
                       ...
                       if (i.qsa && !_[e + " "] && (!v || !v.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                           if (((m = e), (y = t), 1 === x && (B.test(e) || W.test(e)))) {
                               for (((y = (ee.test(e) && me(t.parentNode)) || t) === t && i.scope) || ((d = t.getAttribute("id")) ? (d = d.replace(ne, oe)) : t.setAttribute("id", (d = w))), a = (f = r(e)).length; a--; )
               ...
               (p = ae.setDocument = function (e) {
                   ...
                   return r != h && 9 === r.nodeType && r.documentElement
                       ? ((f = (h = r).documentElement),
                         (g = !s(h)),
                         x != h && (o = h.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", se, !1) : o.attachEvent && o.attachEvent("onunload", se)),
                         ...
                         (m = []),
                         (v = []),
                         (i.qsa = Z.test(h.querySelectorAll)) &&
                             (de(function (e) {
                                 var t;
                                 (f.appendChild(e).innerHTML = "<a id='" + w + "'></a><select id='" + w + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                     ...
                                     e.querySelectorAll("[selected]").length || v.push("\\[" + N + "*(?:value|" + j + ")"),
                         ...
                         (P = t
                             ...
                             : function (e, t) {
                                   ...
                                   var i,
                                       ...
                                       r = [e],
                                       a = [t];
                                   if (!o || !s) return e == h ? -1 : t == h ? 1 : o ? -1 : s ? 1 : d ? H(d, e) - H(d, t) : 0;
               ...
               (ae.matchesSelector = function (e, t) {
                   if ((p(e), i.matchesSelector && g && !_[t + " "] && (!m || !m.test(t)) && (!v || !v.test(t))))
                       try {
                           var n = y.call(e, t);
                   ...
                   preFilter: {
                       ...
                       PSEUDO: function (e) {
                           ...
                           return U.CHILD.test(e[0])
                               ? null
                               : (e[3] ? (e[2] = e[4] || e[5] || "") : i && X.test(i) && (t = r(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && ((e[0] = e[0].slice(0, t)), (e[2] = i.slice(0, t))), e.slice(0, 3));
                       },
                   },
                   filter: {
                       TAG: function (e) {
                               ...
                               : function (t, i, l) {
                                     ...
                                     if (v) {
                                         ...
                                         if (((f = [r ? v.firstChild : v.lastChild]), r && y)) {
                                             for (
                                                 b = (h = (c = (d = (u = (p = v)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2], p = h && v.childNodes[h];
                   ...
                   return (
                       ...
                       ce(function (s, r, a, l) {
                           var c,
                               ...
                               m = i ? (o || (s ? e : f || n) ? [] : r) : v;
                           if ((i && i(v, m, a, l), n)) for (c = Te(m, h), n(c, [], a, l), d = c.length; d--; ) (u = c[d]) && (m[h[d]] = !(v[h[d]] = u));
                           if (s) {
                               if (o || e) {
                                   if (o) {
                                   ...
                                   for (d = m.length; d--; ) (u = m[d]) && (c = o ? H(s, u) : p[d]) > -1 && (s[c] = !(r[c] = u));
                               }
                           } else (m = Te(m === r ? m.splice(f, m.length) : m)), o ? o(null, r, m, l) : L.apply(r, m);
                       })
                   );
               }
               function Ce(e) {
                   for (
                       ...
                       if ((i = n.relative[e[l].type])) p = [we(xe(p), i)];
                           ...
                           if ((i = n.filter[e[l].type].apply(null, e[l].matches))[w]) {
                               ...
                               return Se(l > 1 && xe(p), l > 1 && be(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(R, "$1"), i, l < o && Ce(e.slice(l, o)), o < s && Ce((e = e.slice(o))), o < s && be(e));
                           }
                           p.push(i);
                       }
                   return xe(p);
               ...
               return (
                   ...
                   (r = ae.tokenize = function (e, t) {
                       ...
                       for (a = e, l = [], c = n.preFilter; a; ) {
                           for (r in ((i && !(o = V.exec(a))) || (o && (a = a.slice(o[0].length) || a), l.push((s = []))),
                           (i = !1),
                           (o = W.exec(a)) && ((i = o.shift()), s.push({ value: i, type: o[0].replace(R, " ") }), (a = a.slice(i.length))),
                           n.filter))
                               !(o = U[r].exec(a)) || (c[r] && !(o = c[r](o))) || ((i = o.shift()), s.push({ value: i, type: r, matches: o }), (a = a.slice(i.length)));
                           if (!i) break;
                       }
                                   ...
                                   var i = t.length > 0,
                                       ...
                                       s = function (s, r, a, l, d) {
                                           var u,
                                               ...
                                               k = S.length;
                                           for (d && (c = r == h || r || d); y !== k && null != (u = S[y]); y++) {
                                               if (o && u) {
                                           ...
                                           if (((m += y), i && y !== m)) {
                                               ...
                                               if (s) {
                                                   if (m > 0) for (; y--; ) b[y] || w[y] || (w[y] = M.call(l));
                                                   w = Te(w);
                                               }
                                               L.apply(l, w), d && !s && w.length > 0 && m + t.length > 1 && ae.uniqueSort(l);
                                           }
                                           return d && ((T = C), (c = x)), b;
                                       };
                                   return i ? ce(s) : s;
                   ...
                   (l = ae.select = function (e, t, i, o) {
                       ...
                       if (((i = i || []), 1 === h.length)) {
                           ...
                           for (s = U.needsContext.test(e) ? 0 : l.length; s-- && ((c = l[s]), !n.relative[(d = c.type)]); )
                               if ((u = n.find[d]) && (o = u(c.matches[0].replace(te, ie), (ee.test(l[0].type) && me(t.parentNode)) || t))) {
                                   if ((l.splice(s, 1), !(e = o.length && be(l)))) return L.apply(i, o), i;
                                   break;
                               }
                       }
       ...
       (w.filter = function (e, t, i) {
           ...
           w.fn.extend({
               ...
               is: function (e) {
                   return !!P(this, "string" == typeof e && k.test(e) ? w(e) : e || [], !1).length;
               },
           });
       var E,
           A = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
       ((w.fn.init = function (e, t, i) {
           ...
           if (((i = i || E), "string" == typeof e)) {
               ...
               if (n[1]) {
                   if (((t = t instanceof w ? t[0] : t), w.merge(this, w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : v, !0)), _.test(n[1]) && w.isPlainObject(t))) for (n in t) f(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                   return this;
               }
               return (o = v.getElementById(n[2])) && ((this[0] = o), (this.length = 1)), this;
           }
           ...
           w.each(
               {
                   ...
                   contents: function (e) {
                       return null != e.contentDocument && n(e.contentDocument) ? e.contentDocument : ($(e, "template") && (e = e.content || e), w.merge([], e.childNodes));
                   },
               },
               function (e, t) {
                   w.fn[e] = function (i, n) {
                       var o = w.map(this, t, i);
                       return "Until" !== e.slice(-5) && (n = i), n && "string" == typeof n && (o = w.filter(n, o)), this.length > 1 && (D[e] || w.uniqueSort(o), M.test(e) && o.reverse()), this.pushStack(o);
                   };
               }
           );
       var O = /[^\x20\t\r\n\f]+/g;
       ...
       (w.Callbacks = function (e) {
                   ...
                   remove: function () {
                       return (
                           w.each(arguments, function (e, t) {
                               for (var i; (i = w.inArray(t, s, i)) > -1; ) s.splice(i, 1), i <= a && a--;
                           }),
                           this
                       );
                   },
           ...
           w.extend({
                   ...
                   var i = [
                       ...
                       o = {
                           ...
                           then: function (t, n, o) {
                                           ...
                                           c = function () {
                                               ...
                                               if (!(t < s)) {
                                                   ...
                                                   (c = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                       f(c)
                                                           ? o
                                                               ? c.call(e, r(s, i, H, o), r(s, i, j, o))
                                                               : (s++, c.call(e, r(s, i, H, o), r(s, i, j, o), r(s, i, H, i.notifyWith)))
                                                           : (n !== H && ((a = void 0), (l = [e])), (o || i.resolveWith)(a, l));
                                               }
                                           },
                                           d = o
                                               ? c
                                               : function () {
                                                     try {
                                                         ...
                                                         w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= s && (n !== j && ((a = void 0), (l = [e])), i.rejectWith(a, l));
                                                     }
                                                 };
                               ...
                               return w
                                   .Deferred(function (e) {
                                       i[0][3].add(r(0, e, f(o) ? o : H, e.notifyWith)), i[1][3].add(r(0, e, f(t) ? t : H)), i[2][3].add(r(0, e, f(n) ? n : j));
                                   })
                                   .promise();
                           },
                           promise: function (e) {
               ...
               when: function (e) {
                   ...
                   if (t <= 1 && (N(e, r.done(a(i)).resolve, r.reject, !t), "pending" === r.state() || f(s[i] && s[i].then))) return r.then();
                   for (; i--; ) N(s[i], a(i), r.reject);
                   return r.promise();
               },
           });
       ...
       (w.fn.ready = function (e) {
           ...
           w.extend({
               ...
               readyWait: 1,
               ready: function (e) {
                   (!0 === e ? --w.readyWait : w.isReady) || ((w.isReady = !0), (!0 !== e && --w.readyWait > 0) || z.resolveWith(v, [w]));
               },
           }),
           (w.ready.then = z.then),
       ...
       var F = function (e, t, i, n, o, s, r) {
               var a = 0,
                   l = e.length,
                   c = null == i;
               if ("object" === b(i)) for (a in ((o = !0), i)) F(e, t, a, i[a], !0, s, r);
               else if (
                   void 0 !== n &&
                   ((o = !0),
                   f(n) || (r = !0),
       ...
       function B(e) {
           return e.replace(R, "ms-").replace(V, W);
       }
       var X = function (e) {
       ...
       (Y.uid = 1),
           (Y.prototype = {
               ...
               remove: function (e, t) {
                   ...
                   if (void 0 !== n) {
                       if (void 0 !== t) {
                           i = (t = Array.isArray(t) ? t.map(B) : (t = B(t)) in n ? [t] : t.match(O) || []).length;
                           for (; i--; ) delete n[t[i]];
                       }
       ...
       w.extend({
               ...
               data: function (e, t) {
                   ...
                   if (void 0 === e) {
                       if (this.length && ((o = G.get(s)), 1 === s.nodeType && !U.get(s, "hasDataAttrs"))) {
                           for (i = r.length; i--; ) r[i] && 0 === (n = r[i].name).indexOf("data-") && ((n = B(n.slice(5))), Z(s, n, o[n]));
                   ...
                   return "object" == typeof e
                       ...
                       : F(
                             ...
                             function (t) {
                                 var i;
                                 if (s && void 0 === t) return void 0 !== (i = G.get(s, e)) || void 0 !== (i = Z(s, e)) ? i : void 0;
                                 this.each(function () {
                                     G.set(this, e, t);
                                 });
                             },
           ...
           w.fn.extend({
               ...
               promise: function (e, t) {
                   ...
                   for ("string" != typeof e && ((t = e), (e = void 0)), e = e || "fx"; r--; ) (i = U.get(s[r], e + "queueHooks")) && i.empty && (n++, i.empty.add(a));
       ...
       function le(e) {
           var t,
               ...
               n = e.nodeName,
               o = ae[n];
           return o || ((t = i.body.appendChild(i.createElement(n))), (o = w.css(t, "display")), t.parentNode.removeChild(t), "none" === o && (o = "block"), (ae[n] = o), o);
       }
       function ce(e, t) {
           for (var i, n, o = [], s = 0, r = e.length; s < r; s++)
               (n = e[s]).style &&
                   ((i = n.style.display),
                   t ? ("none" === i && ((o[s] = U.get(n, "display") || null), o[s] || (n.style.display = "")), "" === n.style.display && se(n) && (o[s] = le(n))) : "none" !== i && ((o[s] = "none"), U.set(n, "display", i)));
       ...
       function be(e, t, i, n, o) {
           ...
           for (u.textContent = "", h = 0; (s = p[h++]); )
               ...
               else if (((c = ne(s)), (r = ve(u.appendChild(s), "script")), c && me(r), i)) for (d = 0; (s = r[d++]); ) fe.test(s.type || "") && i.push(s);
           return u;
       }
       var we = /^([^.]*)(?:\.(.+)|)/;
       function xe() {
                 ...
                 w.event.add(e, t, {
                     ...
                     handler: function (e) {
                         ...
                         if (1 & e.isTrigger && this[t]) {
                             ...
                             else if (((r = o.call(arguments)), U.set(this, t, r), (n = i(this, t)), this[t](), r !== (s = U.get(this, t)) || n ? U.set(this, t, !1) : (s = {}), r !== s))
                                 return e.stopImmediatePropagation(), e.preventDefault(), s && s.value;
                         } else r.length && (U.set(this, t, { value: w.event.trigger(w.extend(r[0], w.Event.prototype), r.slice(1), this) }), e.stopImmediatePropagation());
                     },
                 }))
               : void 0 === U.get(e, t) && w.event.add(e, t, xe);
       }
       (w.event = {
           global: {},
                   ...
                   for (
                       ...
                       (h = g = (a = we.exec(t[c]) || [])[1]),
                           ...
                           h &&
                               ...
                               (u = w.event.special[h] || {}),
                               (d = w.extend({ type: h, origType: g, data: n, handler: i, guid: i.guid, selector: o, needsContext: o && w.expr.match.needsContext.test(o), namespace: f.join(".") }, s)),
                               (p = l[h]) || (((p = l[h] = []).delegateCount = 0), (u.setup && !1 !== u.setup.call(e, n, f, r)) || (e.addEventListener && e.addEventListener(h, r))),
               ...
               if (v && (l = v.events)) {
                   for (c = (t = (t || "").match(O) || [""]).length; c--; )
                       if (((h = g = (a = we.exec(t[c]) || [])[1]), (f = (a[2] || "").split(".").sort()), h)) {
                           for (u = w.event.special[h] || {}, p = l[(h = (n ? u.delegateType : u.bindType) || h)] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = p.length; s--; )
                               (d = p[s]),
                                   (!o && g !== d.origType) ||
                                       (i && i.guid !== d.guid) ||
                           ...
                           r && !p.length && ((u.teardown && !1 !== u.teardown.call(e, f, v.handle)) || w.removeEvent(e, h, v.handle), delete l[h]);
           ...
           dispatch: function (e) {
               ...
               if (((l.delegateTarget = this), !d.preDispatch || !1 !== d.preDispatch.call(this, l))) {
                   for (r = w.event.handlers.call(this, l, c), t = 0; (o = r[t++]) && !l.isPropagationStopped(); )
                       for (l.currentTarget = o.elem, i = 0; (s = o.handlers[i++]) && !l.isImmediatePropagationStopped(); )
                           (l.rnamespace && !1 !== s.namespace && !l.rnamespace.test(s.namespace)) ||
                               ((l.handleObj = s), (l.data = s.data), void 0 !== (n = ((w.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) && !1 === (l.result = n) && (l.preventDefault(), l.stopPropagation()));
               ...
               if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                   for (; c !== this; c = c.parentNode || this)
                       if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                           for (s = [], r = {}, i = 0; i < l; i++) void 0 === r[(o = (n = t[i]).selector + " ")] && (r[o] = n.needsContext ? w(o, this).index(c) > -1 : w.find(o, this, null, [c]).length), r[o] && s.push(n);
           ...
           special: {
               ...
               click: {
                   setup: function (e) {
                       var t = this || e;
                       return pe.test(t.type) && t.click && $(t, "input") && ke(t, "click", xe), !1;
                   },
                   trigger: function (e) {
                       var t = this || e;
                   ...
                   _default: function (e) {
                       var t = e.target;
                       return (pe.test(t.type) && t.click && $(t, "input") && U.get(t, "click")) || $(t, "a");
                   },
               },
               beforeunload: {
               ...
               w.event.special[e] = {
                   ...
                   handle: function (e) {
                       var i,
                           ...
                           o = e.relatedTarget,
                           s = e.handleObj;
                       return (o && (o === n || w.contains(n, o))) || ((e.type = s.origType), (i = s.handler.apply(this, arguments)), (e.type = t)), i;
                   },
               };
           }),
           w.fn.extend({
       ...
       function De(e, t) {
           var i, n, o, s, r, a;
           if (1 === t.nodeType) {
               if (U.hasData(e) && (a = U.get(e).events)) for (o in (U.remove(t, "handle events"), a)) for (i = 0, n = a[o].length; i < n; i++) w.event.add(t, o, a[o][i]);
               G.hasData(e) && ((s = G.access(e)), (r = w.extend({}, s)), G.set(t, r));
           }
       }
       function Le(e, t) {
           var i = t.nodeName.toLowerCase();
       ...
       function Oe(e, t, i, n) {
           ...
           var o,
               ...
               v = t[0],
               m = f(v);
           if (m || (p > 1 && "string" == typeof v && !h.checkClone && _e.test(v)))
               return e.each(function (o) {
                   var s = e.eq(o);
                   m && (t[0] = v.call(this, o, s.html())), Oe(s, t, i, n);
               });
           if (p && ((r = (o = be(t, e[0].ownerDocument, !1, e, n)).firstChild), 1 === o.childNodes.length && (o = r), r || n)) {
               for (l = (a = w.map(ve(o, "script"), Ae)).length; u < p; u++) (c = o), u !== g && ((c = w.clone(c, !0, !0)), l && w.merge(a, ve(c, "script"))), i.call(e[u], c, u);
               if (l)
                   for (d = a[a.length - 1].ownerDocument, w.map(a, Me), u = 0; u < l; u++)
                       (c = a[u]),
                           fe.test(c.type || "") &&
                               !U.access(c, "globalEval") &&
                               w.contains(d, c) &&
                               (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, d) : y(c.textContent.replace(Pe, ""), c, d));
           }
           return e;
       }
       function He(e, t, i) {
           for (var n, o = t ? w.filter(t, e) : e, s = 0; null != (n = o[s]); s++) i || 1 !== n.nodeType || w.cleanData(ve(n)), n.parentNode && (i && ne(n) && me(ve(n, "script")), n.parentNode.removeChild(n));
           return e;
       }
       w.extend({
           ...
           clone: function (e, t, i) {
               var n,
                   ...
                   a = e.cloneNode(!0),
                   l = ne(e);
               if (!(h.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e))) for (r = ve(a), n = 0, o = (s = ve(e)).length; n < o; n++) Le(s[n], r[n]);
               if (t)
                   if (i) for (s = s || ve(e), r = r || ve(a), n = 0, o = s.length; n < o; n++) De(s[n], r[n]);
                   else De(e, a);
       ...
       function qe(e, t, i) {
           ...
           return (
               (i = i || Ne(e)) &&
                   ("" !== (r = i.getPropertyValue(t) || i[t]) || ne(e) || (r = w.style(e, t)),
                   !h.pixelBoxStyles() && je.test(r) && ze.test(t) && ((n = a.width), (o = a.minWidth), (s = a.maxWidth), (a.minWidth = a.maxWidth = a.width = r), (r = i.width), (a.width = n), (a.minWidth = o), (a.maxWidth = s))),
               void 0 !== r ? r + "" : r
           );
       }
       function Fe(e, t) {
                   ...
                   reliableTrDimensions: function () {
                       ...
                       return (
                           null == a &&
                               ...
                               ie.appendChild(t).appendChild(i).appendChild(n),
       ...
       function Be(e) {
           ...
           return (
               ...
               (e in Ve
                   ...
                   : (We[e] =
                         (function (e) {
                             for (var t = e[0].toUpperCase() + e.slice(1), i = Re.length; i--; ) if ((e = Re[i] + t) in Ve) return e;
                         })(e) || e))
           );
       }
       ...
       function Ke(e, t, i, n, o, s) {
           ...
           for (; r < 4; r += 2)
               "margin" === i && (l += w.css(e, i + te[r], !0, o)),
                   n
                       ? ("content" === i && (l -= w.css(e, "padding" + te[r], !0, o)), "margin" !== i && (l -= w.css(e, "border" + te[r] + "Width", !0, o)))
                       : ((l += w.css(e, "padding" + te[r], !0, o)), "padding" !== i ? (l += w.css(e, "border" + te[r] + "Width", !0, o)) : (a += w.css(e, "border" + te[r] + "Width", !0, o)));
       ...
       function Ze(e, t, i) {
           ...
           return (
               ((!h.boxSizingReliable() && o) || (!h.reliableTrDimensions() && $(e, "tr")) || "auto" === r || (!parseFloat(r) && "inline" === w.css(e, "display", !1, n))) &&
                   e.getClientRects().length &&
                   ((o = "border-box" === w.css(e, "boxSizing", !1, n)), (s = a in e) && (r = e[a])),
               (r = parseFloat(r) || 0) + Ke(e, t, i || (o ? "border" : "content"), s, n, r) + "px"
           );
       }
       ...
       w.extend({
           ...
           style: function (e, t, i, n) {
               if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                   ...
                   "string" === (s = typeof i) && (o = ee.exec(i)) && o[1] && ((i = re(e, t, o)), (s = "number")),
                       null != i &&
                           i == i &&
                           ("number" !== s || l || (i += (o && o[3]) || (w.cssNumber[a] ? "" : "px")),
           ...
           css: function (e, t, i, n) {
               ...
               return (
                   Ye.test(t) || (t = Be(a)),
                   (r = w.cssHooks[t] || w.cssHooks[a]) && "get" in r && (o = r.get(e, !0, i)),
                   void 0 === o && (o = qe(e, t, n)),
               ...
               w.cssHooks[t] = {
                   ...
                   set: function (e, i, n) {
                       ...
                       return (
                           ...
                           l && (o = ee.exec(i)) && "px" !== (o[3] || "px") && ((e.style[t] = i), (i = w.css(e, t))),
                           Qe(0, i, l)
                       );
                   },
               };
           ...
           w.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
               (w.cssHooks[e + t] = {
                   expand: function (i) {
                       for (var n = 0, o = {}, s = "string" == typeof i ? i.split(" ") : [i]; n < 4; n++) o[e + te[n] + t] = s[n] || s[n - 2] || s[0];
                       return o;
                   },
               }),
                   ...
                   return F(
                       ...
                       function (e, t, i) {
                           var n,
                               ...
                               r = 0;
                           if (Array.isArray(t)) {
                               for (n = Ne(e), o = t.length; r < o; r++) s[t[r]] = w.css(e, t[r], !1, n);
                               return s;
                           }
       ...
       var et,
           ...
           nt = /queueHooks$/;
       function ot() {
           tt && (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(ot) : e.setTimeout(ot, w.fx.interval), w.fx.tick());
       }
       function st() {
           return (
               e.setTimeout(function () {
       ...
       function at(e, t, i) {
           for (var n, o = (lt.tweeners[t] || []).concat(lt.tweeners["*"]), s = 0, r = o.length; s < r; s++) if ((n = o[s].call(i, t, e))) return n;
       }
       function lt(e, t, i) {
           var n,
               o,
               ...
               l = function () {
                   if (o) return !1;
                   for (var t = et || st(), i = Math.max(0, c.startTime + c.duration - t), n = 1 - (i / c.duration || 0), s = 0, r = c.tweens.length; s < r; s++) c.tweens[s].run(n);
           ...
           for (
               !(function (e, t) {
                   var i, n, o, s, r;
                   for (i in e)
                       if (((o = t[(n = B(i))]), (s = e[i]), Array.isArray(s) && ((o = s[1]), (s = e[i] = s[0])), i !== n && ((e[n] = s), delete e[i]), (r = w.cssHooks[n]) && ("expand" in r)))
               ...
               if ((n = lt.prefilters[s].call(c, e, d, c.opts))) return f(n.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
           return (
               w.map(d, at, c),
       ...
       (w.Animation = w.extend(lt, {
                   ...
                   if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(h))
                       ...
                       h))
                           l ||
                               ...
                               g && ce([e], !0),
                               p.done(function () {
                                   for (n in (g || ce([e]), U.remove(e, "fxshow"), h)) w.style(e, n, h[n]);
                               })),
                               (l = at(g ? v[n] : 0, n, p)),
               ...
               stop: function (e, t, i) {
                   ...
                   return (
                       ...
                       this.each(function () {
                           ...
                           else for (o in r) r[o] && r[o].stop && nt.test(o) && n(r[o]);
           ...
           w.each(["toggle", "show", "hide"], function (e, t) {
               ...
               w.fn[t] = function (e, n, o) {
                   return null == e || "boolean" == typeof e ? i.apply(this, arguments) : this.animate(rt(t, !0), e, n, o);
               };
           }),
           ...
           (w.fx.tick = function () {
               var e,
                   t = 0,
                   i = w.timers;
               for (et = Date.now(); t < i.length; t++) (e = i[t])() || i[t] !== e || i.splice(t--, 1);
               i.length || w.fx.stop(), (et = void 0);
           }),
       ...
       w.fn.extend({
               ...
               attr: function (e, t, i) {
                   ...
                   if (3 !== s && 8 !== s && 2 !== s)
                       return void 0 === e.getAttribute
                           ? w.prop(e, t, i)
                           : ((1 === s && w.isXMLDoc(e)) || (o = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ct : void 0)),
                             void 0 !== i
                                 ? null === i
           ...
           w.each(w.expr.match.bool.source.match(/\w+/g), function (e, t) {
               var i = dt[t] || w.find.attr;
               dt[t] = function (e, t, n) {
                   var o,
                       s,
                       r = t.toLowerCase();
                   return n || ((s = dt[r]), (dt[r] = o), (o = null != i(e, t, n) ? r : null), (dt[r] = s)), o;
               };
           });
           ...
           w.fn.extend({
               ...
               toggleClass: function (e, t) {
                   ...
                   return "boolean" == typeof t && n
                       ...
                       : this.each(function () {
                             var t, o, s, r;
                             if (n) for (o = 0, s = w(this), r = gt(e); (t = r[o++]); ) s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
               ...
               hasClass: function (e) {
                   var t,
                       i,
                       n = 0;
                   for (t = " " + e + " "; (i = this[n++]); ) if (1 === i.nodeType && (" " + ht(ft(i)) + " ").indexOf(t) > -1) return !0;
                   return !1;
               },
           });
       var vt = /\r/g;
       w.fn.extend({
           val: function (e) {
               ...
               return arguments.length
                   ...
                   : o
                   ? (t = w.valHooks[o.type] || w.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (i = t.get(o, "value"))
                       ? i
       ...
       w.extend(w.event, {
           trigger: function (t, i, n, o) {
               ...
               if (
                   ...
                   if (!o && !p.noBubble && !g(n)) {
                       for (l = p.delegateType || y, mt.test(l + y) || (r = r.parentNode); r; r = r.parentNode) m.push(r), (a = r);
                       a === (n.ownerDocument || v) && m.push(a.defaultView || a.parentWindow || e);
                   }
                   for (s = 0; (r = m[s++]) && !t.isPropagationStopped(); )
                       (h = r),
                           (t.type = s > 1 ? l : p.bindType || y),
                           (u = (U.get(r, "events") || Object.create(null))[t.type] && U.get(r, "handle")) && u.apply(r, i),
                           (u = c && r[c]) && u.apply && X(r) && ((t.result = u.apply(r, i)), !1 === t.result && t.preventDefault());
                   return (
                       (t.type = y),
                       o ||
                           t.isDefaultPrevented() ||
                           (p._default && !1 !== p._default.apply(m.pop(), i)) ||
                           !X(n) ||
                           (c &&
                               f(n[y]) &&
                               !g(n) &&
           ...
           w.fn.extend({
               ...
               serializeArray: function () {
                   return this.map(function () {
                       ...
                       .filter(function () {
                           var e = this.type;
                           return this.name && !w(this).is(":disabled") && kt.test(this.nodeName) && !Ct.test(e) && (this.checked || !pe.test(e));
                       })
                       .map(function (e, t) {
                           var i = w(this).val();
                           return null == i
       ...
       function Nt(e) {
           return function (t, i) {
               ...
               if (f(i)) for (; (n = s[o++]); ) "+" === n[0] ? ((n = n.slice(1) || "*"), (e[n] = e[n] || []).unshift(i)) : (e[n] = e[n] || []).push(i);
           };
       }
       function It(e, t, i, n) {
           var o = {},
       ...
       (jt.href = bt.href),
           w.extend({
               ...
               ajax: function (t, i) {
                   ...
                   var n,
                       ...
                       C = {
                           ...
                           getResponseHeader: function (e) {
                               var t;
                               if (c) {
                                   if (!r) for (r = {}; (t = At.exec(s)); ) r[t[1].toLowerCase() + " "] = (r[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                   t = r[e.toLowerCase() + " "];
                               }
                   ...
                   if (
                       (m.promise(C),
                       (h.url = ((t || h.url || bt.href) + "").replace(Dt, bt.protocol + "//")),
                   ...
                   if ((h.data && h.processData && "string" != typeof h.data && (h.data = w.param(h.data, h.traditional)), It(Lt, h, i, C), c)) return C;
                   for (u in ((d = w.event && h.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                   ...
                   h.hasContent
                       ...
                       : ((p = h.url.slice(o.length)),
                         h.data && (h.processData || "string" == typeof h.data) && ((o += (xt.test(o) ? "&" : "?") + h.data), delete h.data),
                         !1 === h.cache && ((o = o.replace(Et, "$1")), (p = (xt.test(o) ? "&" : "?") + "_=" + wt.guid++ + p)),
                         (h.url = o + p)),
                   h.ifModified && (w.lastModified[o] && C.setRequestHeader("If-Modified-Since", w.lastModified[o]), w.etag[o] && C.setRequestHeader("If-None-Match", w.etag[o])),
                   ...
                   if (((S = "abort"), y.add(h.complete), C.done(h.success), C.fail(h.error), (n = It(Ot, h, i, C)))) {
                   ...
                   function k(t, i, r, l) {
                       ...
                       c ||
                           ...
                           !u && w.inArray("script", h.dataTypes) > -1 && w.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function () {}),
                           (x = (function (e, t, i, n) {
                               var o,
                                   s,
                                   r,
                           ...
                           u
                               ? (h.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (w.lastModified[o] = T), (T = C.getResponseHeader("etag")) && (w.etag[o] = T)),
                                 204 === t || "HEAD" === h.type ? (S = "nocontent") : 304 === t ? (S = "notmodified") : ((S = x.state), (p = x.data), (u = !(v = x.error))))
                               : ((v = S), (!t && S) || ((S = "error"), t < 0 && (t = 0))),
                           (C.status = t),
                           (C.statusText = (i || S) + ""),
                           u ? m.resolveWith(f, [p, S, C]) : m.rejectWith(f, [C, S, v]),
                           C.statusCode(b),
                           (b = void 0),
                           d && g.trigger(u ? "ajaxSuccess" : "ajaxError", [C, h, u ? p : v]),
                           y.fireWith(f, [C, S]),
                           d && (g.trigger("ajaxComplete", [C, h]), --w.active || w.event.trigger("ajaxStop")));
                   }
                   return C;
               },
           ...
           w.each(["get", "post"], function (e, t) {
               w[t] = function (e, i, n, o) {
                   return f(i) && ((o = o || n), (n = i), (i = void 0)), w.ajax(w.extend({ url: e, type: t, dataType: o, data: i, success: n }, w.isPlainObject(e) && e));
               };
           }),
       ...
       w.ajaxSetup({
           ...
           w.ajaxPrefilter("json jsonp", function (t, i, n) {
               ...
               if (a || "jsonp" === t.dataTypes[0])
                   return (
                       ...
                       a ? (t[a] = t[a].replace(Wt, "$1" + o)) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
                       ...
                       n.always(function () {
                           void 0 === s ? w(e).removeProp(o) : (e[o] = s), t[o] && ((t.jsonpCallback = i.jsonpCallback), Vt.push(o)), r && f(s) && s(r[0]), (r = s = void 0);
                       }),
                       "script"
                   );
           }),
           (h.createHTMLDocument = (((Rt = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Rt.childNodes.length)),
           (w.parseHTML = function (e, t, i) {
               return "string" != typeof e
                   ? []
                   : ("boolean" == typeof t && ((i = t), (t = !1)),
                     t || (h.createHTMLDocument ? (((n = (t = v.implementation.createHTMLDocument("")).createElement("base")).href = v.location.href), t.head.appendChild(n)) : (t = v)),
                     (s = !i && []),
                     (o = _.exec(e)) ? [t.createElement(o[1])] : ((o = be([e], t, s)), s && s.length && w(s).remove(), w.merge([], o.childNodes)));
               var n, o, s;
           }),
           (w.fn.load = function (e, t, i) {
               var n,
                   ...
                   a = e.indexOf(" ");
               return (
                   a > -1 && ((n = ht(e.slice(a))), (e = e.slice(0, a))),
           ...
           (w.offset = {
               setOffset: function (e, t, i) {
                   ...
                   "static" === c && (e.style.position = "relative"),
                       ...
                       (s = w.css(e, "top")),
                       (l = w.css(e, "left")),
                       ("absolute" === c || "fixed" === c) && (s + l).indexOf("auto") > -1 ? ((r = (n = d.position()).top), (o = n.left)) : ((r = parseFloat(s) || 0), (o = parseFloat(l) || 0)),
           ...
           w.fn.extend({
               ...
               position: function () {
                   if (this[0]) {
                       ...
                       return { top: t.top - o.top - w.css(n, "marginTop", !0), left: t.left - o.left - w.css(n, "marginLeft", !0) };
                   }
               },
           ...
           w.each(["top", "left"], function (e, t) {
               w.cssHooks[t] = Fe(h.pixelPosition, function (e, i) {
                   if (i) return (i = qe(e, t)), je.test(i) ? w(e).position()[t] + "px" : i;
               });
           }),
       ...
       (t = 0),
           ...
           (e.fn.slick = function () {
               var e,
                   ...
                   r = n.length;
               for (e = 0; e < r; e++) if (("object" == typeof o || void 0 === o ? (n[e].slick = new i(n[e], o)) : (t = n[e].slick[o].apply(n[e].slick, s)), void 0 !== t)) return t;
               return n;
           });
   }),
   (function (e, t, i, n) {
               ...
               i.extend(g.prototype, {
                   ...
                   addContent: function (e) {
                       ...
                       i.each(o, function (e, t) {
                           ...
                           i.isPlainObject(t)
                               ...
                               ? ((d = (o = i(t)).data() || {}), ((d = i.extend(!0, {}, d, d.options)).$orig = o), (c.src = n.opts.src || d.src || o.attr("href")), c.type || c.src || ((c.type = "inline"), (c.src = t)))
                               : (c = { type: "html", src: t + "" }),
                   ...
                   jumpTo: function (e, t) {
                       ...
                       if (!(p.isDragging || p.isClosing || (p.isAnimating && p.firstRun))) {
                           ...
                           if (
                               ...
                               (p.prevPos = p.currPos),
                               (r = p.createSlide(e)),
                               f > 1 && ((s || r.index < f - 1) && p.createSlide(e + 1), (s || r.index > 0) && p.createSlide(e - 1)),
                               (p.current = r),
                               (p.currIndex = r.index),
                               (p.currPos = r.pos),
                               ...
                               return r.opts.animationEffect && t && p.$refs.container.css("transition-duration", t + "ms"), p.$refs.container.addClass("fancybox-is-open").trigger("focus"), p.loadSlide(r), void p.preload("image");
                               ...
                               o
                                   ? ((u = l.left - (a.pos * l.width + a.pos * a.opts.gutter)),
                                     i.each(p.slides, function (e, n) {
                                         ...
                                         i.fancybox.setTranslate(n.$slide, { top: 0, left: o - c.left + u }),
                                             n.pos !== r.pos && n.$slide.addClass("fancybox-slide--" + (n.pos > r.pos ? "next" : "previous")),
                                             h(n.$slide),
                                             i.fancybox.animate(n.$slide, { top: 0, left: (n.pos - r.pos) * l.width + (n.pos - r.pos) * n.opts.gutter }, t, function () {
                   ...
                   scaleToActual: function (e, t, n) {
                       ...
                       c.isAnimating ||
                           ...
                           (s = 0.5 * p - 0.5 * f),
                           (r = 0.5 * h - 0.5 * g),
                           f > p && ((s = o.left * a - (e * a - e)) > 0 && (s = 0), s < p - f && (s = p - f)),
                           g > h && ((r = o.top * l - (t * l - t)) > 0 && (r = 0), r < h - g && (r = h - g)),
                           c.updateCursor(f, g),
                           i.fancybox.animate(u, { top: r, left: s, scaleX: a, scaleY: l }, n || 366, function () {
                               c.isAnimating = !1;
                           }),
                   ...
                   scaleToFit: function (e) {
                       ...
                       n.isAnimating ||
                           ...
                           i.fancybox.animate(s, { top: t.top, left: t.left, scaleX: t.width / s.width(), scaleY: t.height / s.height() }, e || 366, function () {
                               n.isAnimating = !1;
                           }));
                   },
                   getFitPos: function (e) {
                       ...
                       return (
                           ...
                           (l && c) || ((l = t), (c = n)),
                           (l *= o = Math.min(1, t / l, n / c)) > t - 0.5 && (l = t),
                           (c *= o) > n - 0.5 && (c = n),
                           "image" === e.type
                               ? ((d.top = Math.floor(0.5 * (n - c)) + parseFloat(a.css("paddingTop"))), (d.left = Math.floor(0.5 * (t - l)) + parseFloat(a.css("paddingLeft"))))
                   ...
                   updateSlide: function (e, t) {
                       ...
                       this.adjustCaption(e),
                           n && (o || s || "video" === e.contentType) && !e.hasError && (i.fancybox.stop(n), i.fancybox.setTranslate(n, this.getFitPos(e)), e.pos === this.currPos && ((this.isAnimating = !1), this.updateCursor())),
                           this.adjustLayout(e),
                           r.length &&
                               (r.trigger("refresh"),
                   ...
                   isMoved: function (e) {
                       var t,
                           n,
                           o = e || this.current;
                       return !!o && ((n = i.fancybox.getTranslate(this.$refs.stage)), (t = i.fancybox.getTranslate(o.$slide)), !o.$slide.hasClass("fancybox-animated") && (Math.abs(t.top - n.top) > 0.5 || Math.abs(t.left - n.left) > 0.5));
                   },
                   updateCursor: function (e, t) {
                       ...
                       s &&
                           ...
                           (o = !!(n = this.canPan(e, t)) || this.isZoomable()),
                   ...
                   canPan: function (e, t) {
                       ...
                       return (
                           "image" === n.type &&
                               ...
                               !n.hasError &&
                               ((s = this.getFitPos(n)),
                               void 0 !== e && void 0 !== t ? (o = { width: e, height: t }) : n.isComplete && (o = i.fancybox.getTranslate(n.$content)),
                       ...
                       (e.$image = s
                           ...
                           .one("load", function () {
                               ...
                               e.$ghost || (n.resolveImageSlideSize(e, this.naturalWidth, this.naturalHeight), n.afterLoad(e)),
                                   n.isClosing ||
                                       (e.opts.srcset &&
                                           (((t = e.opts.sizes) && "auto" !== t) || (t = (e.width / e.height > 1 && a.width() / a.height() > 1 ? "100" : Math.round((e.width / e.height) * 100)) + "vw"),
                   ...
                   setIframe: function (e) {
                       var t,
                           ...
                           o = e.opts.iframe,
                           s = e.$slide;
                       (e.$content = i('<div class="fancybox-content' + (o.preload ? " fancybox-is-hidden" : "") + '"></div>')
                           .css(o.css)
                           .appendTo(s)),
                           s.addClass("fancybox-slide--" + e.contentType),
                           (e.$iframe = t = i(o.tpl.replace(/\{rnd\}/g, new Date().getTime()))
                               .attr(o.attr)
                               .appendTo(e.$content)),
                           o.preload
                               ? (n.showLoading(e),
                   ...
                   adjustCaption: function (e) {
                       ...
                       s.toggleClass("fancybox-caption--separate", o),
                           o &&
                               n &&
                               n.length &&
                               (i.pos !== this.currPos ? ((t = s.clone().appendTo(s.parent())).children().eq(0).empty().html(n), (r = t.outerHeight(!0)), t.empty().remove()) : this.$caption && (r = this.$caption.outerHeight(!0)),
                   ...
                   adjustLayout: function (e) {
                       ...
                       s.isLoaded &&
                           ...
                           s.$content.outerHeight() > s.$slide.height() + 0.5 &&
                               ...
                               parseFloat(o) > 0 && ((t = s.$slide[0].scrollHeight), s.$slide.css("padding-bottom", 0), Math.abs(t - s.$slide[0].scrollHeight) < 1 && (i = o), s.$slide.css("padding-bottom", n))),
                   ...
                   focus: function (e, n) {
                       ...
                       this.isClosing ||
                           ((o = (o = !e && this.current && this.current.isComplete ? this.current.$slide.find("*:visible" + (n ? ":not(.fancybox-close-small)" : "")) : this.$refs.container.find("*:visible")).filter(r).filter(function () {
                               ...
                               : (u.removeEvents(),
                                 ...
                                 "zoom" === n
                                     ? (i.fancybox.stop(s),
                                       ...
                                       !0)
                                     : (n && o ? i.fancybox.animate(p.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + n, o, f) : !0 === e ? setTimeout(f, o) : f(),
                                       !0)))
                       );
                   },
                   cleanUp: function (t) {
                       ...
                       this.current.$slide.trigger("onReset"),
                           ...
                           this.current.opts.backFocus && ((r && r.length && r.is(":visible")) || (r = this.$trigger), r && r.length && ((o = e.scrollX), (s = e.scrollY), r.trigger("focus"), i("html, body").scrollTop(s).scrollLeft(o))),
                           (this.current = null),
                   ...
                   trigger: function (e, t) {
                       ...
                       if ((r ? o.unshift(r) : (r = s), o.unshift(s), i.isFunction(r.opts[e]) && (n = r.opts[e].apply(r, o)), !1 === n)) return n;
                   ...
                   updateControls: function () {
                       ...
                       e.$slide.trigger("refresh"),
                           ...
                           o.find("[data-fancybox-next]").prop("disabled", !e.opts.loop && n >= this.group.length - 1),
                           "image" === e.type
                               ? o
                   ...
                   (i.fn.fancybox = function (e) {
                       var t;
                       return (t = (e = e || {}).selector || !1) ? i("body").off("click.fb-start", t).on("click.fb-start", t, { options: e }, v) : this.off("click.fb-start").on("click.fb-start", { items: this, options: e }, v), this;
                   }),
       ...
       function v(e, t) {
           ...
           (e && e.isDefaultPrevented()) ||
               ...
               ((s = i.fancybox.getInstance()) && s.$trigger && s.$trigger.is(n)) ||
                   ((r = t.selector ? i(t.selector) : (o = n.attr("data-fancybox") || "") ? ((r = e.data ? e.data.items : []).length ? r.filter('[data-fancybox="' + o + '"]') : i('[data-fancybox="' + o + '"]')) : [n]),
                   (a = i(r).index(n)) < 0 && (a = 0),
                   ((s = i.fancybox.open(r, t, a)).$trigger = n)));
       }
           ...
           (r = e.extend(!0, {}, t, s.opts.media)),
               e.each(r, function (t, n) {
                   if ((l = h.match(n.matcher))) {
                       ...
                       return (
                           (c = e.extend(!0, {}, n.params, s.opts[t], u)),
               ...
               f
                   ? (s.opts.thumb || (s.opts.$thumb && s.opts.$thumb.length) || (s.opts.thumb = a),
                     "iframe" === f && (s.opts = e.extend(!0, s.opts, { iframe: { preload: !1, attr: { scrolling: "no" } } })),
                     e.extend(s, { type: f, src: h, origSrc: s.src, contentSource: p, contentType: "image" === f ? "image" : "gmap_place" == p || "gmap_search" == p ? "map" : "video" }))
   ...
   (function (e, t, i) {
       ...
       var n =
           ...
           a = function (e) {
               ...
               for (var t = 0, n = e[0].attributes, o = n.length; t < o; t++) if ("data-fancybox-" === n[t].nodeName.substr(0, 14)) return !0;
               return !1;
           },
           l = function (t) {
               for (
                   ...
                   (i = t.get(0)),
                       ...
                       !(a = s || r) && (t = t.parent()).length && !t.hasClass("fancybox-stage") && !t.is("body");
       ...
       (c.prototype.destroy = function () {
               ...
               if (!0 !== l)
                       ...
                       (r.requestId = n(function () {
                           r.sliderLastPos &&
                               (i.each(r.instance.slides, function (e, t) {
                                   ...
                                   i.fancybox.setTranslate(t.$slide, { top: r.sliderLastPos.top, left: r.sliderLastPos.left + n * r.canvasWidth + n * t.opts.gutter });
                               }),
                   ...
                   if (
                       ...
                       a.group.length < 2 && r.opts.vertical
                           ? (r.isSwiping = "y")
                           : a.isDragging || !1 === r.opts.vertical || ("auto" === r.opts.vertical && i(e).width() > 800)
                           ? (r.isSwiping = "x")
                   ...
                   (a.isDragging = r.isSwiping),
                       ...
                       i.each(a.slides, function (e, t) {
                           ...
                           i.fancybox.stop(t.$slide),
                               ...
                               t.pos === a.current.pos && ((r.sliderStartPos.top = n.top - o.top), (r.sliderStartPos.left = n.left - o.left)),
           ...
           (c.prototype.limitMovement = function () {
               ...
               return (
                   ...
                   l > 0 && o > e && (o = e - 1 + Math.pow(-e + u + l, 0.8) || 0),
                   l < 0 && o < i && (o = i + 1 - Math.pow(i - u - l, 0.8) || 0),
                   c > 0 && s > t && (s = t - 1 + Math.pow(-t + p + c, 0.8) || 0),
           ...
           (c.prototype.limitPosition = function (e, t, i, n) {
               var o = this.canvasWidth,
                   s = this.canvasHeight;
               return (e = i > o ? ((e = e > 0 ? 0 : e) < o - i ? o - i : e) : Math.max(0, o / 2 - i / 2)), { top: (t = n > s ? ((t = t > 0 ? 0 : t) < s - n ? s - n : t) : Math.max(0, s / 2 - n / 2)), left: e };
           }),
           (c.prototype.onZoom = function () {
               var t = this,
                   ...
                   b = { top: d + (g + (m - t.centerPointStartY)), left: c + (f + y), scaleX: u, scaleY: u };
               (t.canTap = !1),
                   (t.newWidth = p),
                   (t.newHeight = h),
                   (t.contentLastPos = b),
           ...
           (c.prototype.endZooming = function () {
               ...
               this.contentLastPos &&
                   ...
                   (o = { top: (t = this.contentLastPos.top), left: e, width: r, height: a, scaleX: 1, scaleY: 1 }),
                   ...
                   r < this.canvasWidth && a < this.canvasHeight
                       ...
                       : ((n = this.limitPosition(e, t, r, a)), i.fancybox.animate(this.$content, n, 150)));
           }),
       ...
       t.extend(n.prototype, {
           ...
           create: function () {
               var e,
                   ...
                   s = [];
               this.$grid ||
                   ((this.$grid = t('<div class="' + i + " " + i + "-" + this.opts.axis + '"></div>').appendTo(n.$refs.container.find(o).addBack().filter(o))),
           ...
           focus: function (e) {
               ...
               this.instance.current &&
                   ...
                   "y" === this.opts.axis && (i.top < 0 || i.top > n.height() - t.outerHeight())
                       ...
                       : "x" === this.opts.axis && (i.left < o.scrollLeft() || i.left > o.scrollLeft() + (o.width() - t.outerWidth())) && n.parent().stop().animate({ scrollLeft: i.left }, e));
           },
           update: function () {
       ...
       t.extend(!0, t.fancybox.defaults, {
           ...
           t(e).on("click", "[data-fancybox-share]", function () {
               var e,
                   ...
                   r = s.current || null;
               r &&
                   ("function" === t.type(r.opts.share.url) && (e = r.opts.share.url.apply(r, [s, r])),
                   (i = r.opts.share.tpl
                               ...
                               e.location.hash !== "#" + n.currentHash &&
                                   ...
                                   (n.hashTimer = setTimeout(function () {
                                       "replaceState" in e.history
                                           ? (e.history[r ? "pushState" : "replaceState"]({}, t.title, e.location.pathname + e.location.search + "#" + n.currentHash), r && (n.hasCreatedHistory = !0))
                                           : (e.location.hash = n.currentHash),
                                           (n.hashTimer = null);
                                   }, 300))));
                       },
           ...
           "onInit.fb": function (e, t, n) {
               t.$refs.stage.on("mousewheel DOMMouseScroll wheel MozMousePixelScroll", function (e) {
                   ...
                   t.group.length < 2 ||
                       ...
                       (e.preventDefault(),
                       e.stopPropagation(),
                       n.$slide.hasClass("fancybox-animated") || ((e = e.originalEvent || e), o - i < 250 || ((i = o), t[(-e.deltaY || -e.deltaX || e.wheelDelta || -e.detail) < 0 ? "next" : "previous"]())));
               });
           },
       });
   })(document, jQuery),
   $(function () {
       $(".header-top-lang").on("click", function (e) {
           $(".header-top-lang-content").toggleClass("header-top-lang-content--active"), $(this).toggleClass("header-top-lang--active");
       }),
           $(".faq-list__top").on("click", function (e) {
               $(this).toggleClass("faq-list__top--active"), $(this.parentElement).toggleClass("faq-list__item--active");
           }),
           $(".header-bottom__btn").on("click", function (e) {
               $(".header").toggleClass("header--position");

                if (!window.screen.width <= 1250) { $(".header").css('transform', ''); }
            
           }),
           $(".header-bottom__form-btn").on("click", function (e) {
               $(".form-find").toggleClass("form-find--active"), $(document.body).toggleClass("body-find");
           }),
           $(".form-find__top-btn").on("click", function (e) {
               $(".form-find").toggleClass("form-find--active"), $(document.body).toggleClass("body-find");
           }),
           $(".basket-purchase-form-item").on("click", function (e) {
               $(".basket-purchase-form-item--active").toggleClass("basket-purchase-form-item--active"), $(this).toggleClass("basket-purchase-form-item--active"), $(".basket-purchase-form-item__top-checkbox").removeAttr("checked");
           }),
           $(".buying-section-body-box__list-item--1").on("click", function (e) {
               $(".buying-section-body-box__list").toggleClass("buying-section-body-box__list--active");
           }),
           $(".buying-section-body-list-top").on("click", function (e) {
               $(this.parentNode).toggleClass("buying-section-body-list__item--active");
           }),
           $(".product-catalog__top-btn").on("click", function (e) {
               $(".product-catalog-filter-form").toggleClass("product-catalog-filter-form--active");
           }),
           $(".header-bottom__btn").on("click", function (e) {
               $(".menu").toggleClass("menu--active"), $(".header").toggleClass("header--active"), $(".wrapper-biggest").toggleClass("wrapper-biggest--active");
               if (!window.screen.width <= 1250) { $(".header").css('transform', ''); }

            }),
            $(".header-top-lang-content__box-btn").on("click", function (e) {
               $(".header-top-lang-content__box-btn").removeClass("header-top-lang-content__box-btn--active"), $(this).toggleClass("header-top-lang-content__box-btn--active");
           }),
           $(".header-top-lang-content__link").on("click", function (e) {
               $(".header-top-lang-content__link").removeClass("header-top-lang-content__link--active"), $(this).toggleClass("header-top-lang-content__link--active");
           }),
           $(".partners__img").on("dragstart", function (e) {
               return !1;
           }),
           $(".partners__img").on("contextmenu", function (e) {
               return !1;
           }),
           $(".polzunok-5").slider({
               min: 60,
               ...
               animate: "fast",
               slide: function (e, t) {
                   $(".polzunok-input-5-left").val(t.values[0]), $(".polzunok-input-5-right").val(t.values[1]);
               },
           }),
           $(".polzunok-input-5-left").val($(".polzunok-5").slider("values", 0)),
           $(".polzunok-input-5-right").val($(".polzunok-5").slider("values", 1)),
           $(".polzunok-container-5 input").change(function () {
               var e = $(".polzunok-input-5-left")
                       .val()
                       .replace(/[^0-9]/g, ""),
                   t = $(".polzunok-5").slider("option", "min"),
                   i = $(".polzunok-5").slider("values", 1),
                   n = $(".polzunok-input-5-right")
                       .val()
                       .replace(/[^0-9]/g, ""),
                   o = $(".polzunok-5").slider("option", "max"),
                   s = $(".polzunok-5").slider("values", 0);
               e > i && (e = i),
                   e < t && (e = t),
                   "" == e && (e = 0),
                   n < s && (n = s),
                   n > o && (n = o),
                   "" == n && (n = 0),
                   $(".polzunok-input-5-left").val(e),
                   $(".polzunok-input-5-right").val(n),
                   e != s && $(".polzunok-5").slider("values", 0, e),
                   n != i && $(".polzunok-5").slider("values", 1, n);
           });
   }),
   ...
   $(function () {
       mixitup(".draws-info__inner", { load: { filter: ".draw" }, animation: { enable: !1 } });
   }),
   $(function () {
       mixitup(".squad-about__inner", { load: { filter: ".desciption" }, animation: { enable: !1 } });
   }),
   $(function () {
       mixitup(".catalog__inner", { load: { filter: ".item-first" }, animation: { enable: !1 } });
   }),

   new Swiper(".play-now-swiper", {
       slidesPerView: 2,
       spaceBetween: 20,
       navigation: { prevEl: ".play-now-swiper-slide-box-prev", nextEl: ".play-now-swiper-slide-box-next" },
       breakpoints: { 300: { slidesPerView: 1 }, 951: { slidesPerView: 2 } },
   }),
   new Swiper(".promotions-swiper", { slidesPerView: 4, spaceBetween: 0, enabled: !1, breakpoints: { 300: {}, 1301: {} } }),
   new Swiper(".blog-swiper", {
       slidesPerView: 3,
       spaceBetween: 0,
       enabled: !1,
       pagination: { el: ".blog-swiper-pagination", clickable: !0 },
       breakpoints: { 301: { slidesPerView: 1, enabled: !0 }, 901: { enabled: !0, slidesPerView: 2 }, 1301: { enabled: !1, slidesPerView: 3 } },
   }),
   new Swiper(".recalls-swiper", {
       slidesPerView: 3,
       loop: !0,
       navigation: { prevEl: ".recalls-swiper-prev", nextEl: ".recalls-swiper-next" },
       breakpoints: { 300: { slidesPerView: 1 }, 1001: { slidesPerView: 2 }, 1251: { slidesPerView: 3 } },
   }),
   new Swiper(".squad-header-view-swiper", {
       slidesPerView: 3,
       loop: !0,
       navigation: { prevEl: ".squad-header-view-swiper-prev", nextEl: ".squad-header-view-swiper-next" },
       breakpoints: { 300: { slidesPerView: 2.2 }, 451: { slidesPerView: 2.5 }, 601: { slidesPerView: 3 } },
   }),
   new Swiper(".squad-about-swiper", { slidesPerView: 3, enabled: !1, breakpoints: { 300: { enabled: !0, slidesPerView: 2.2, navigation: { enabled: !1 } }, 676: { slidesPerView: 3, enabled: !1 } } }),
   new Swiper(".squad-offers__inner", {
       slidesPerView: 4,
       enabled: !1,
       breakpoints: {
           300: { slidesPerView: 2.2, enabled: !0, centeredSlides: !0, initialSlide: 1 },
           651: { slidesPerView: 3, enabled: !0, centeredSlides: !1, initialSlide: 0 },
           851: { slidesPerView: 4, enabled: !1, centeredSlides: !1, initialSlide: 0 },
       },
   }),
   document.querySelector(".header-blur"))
) {
   if (window.innerWidth > 1e3) {
       let e = document.querySelector(".header-blur");
       window.addEventListener("scroll", () => {
           let t = window.pageYOffset;
           if (t < 10) {
               let i = +("0.0" + Math.floor(t)),
                   n = "background: rgba(6,3,15,";
               e.setAttribute("style", n + i + ");");
           } else if (t < 100 && t > 10) {
               let i = +("0." + Math.floor(t)),
                   n = "background: rgba(6,3,15,";
               e.setAttribute("style", n + i + ");");
           } else {
               let t = 1,
                   i = "background: rgba(6,3,15,";
   ...
   let e = document.querySelector(".squad-header__inner");
   window.addEventListener("scroll", () => {
       let t = window.pageYOffset;
       if (t < 10) {
           let i = +("0.0" + Math.floor(t)),
   ...
   for (
       ...
       ((c = document.createElement("DIV")).innerHTML = selElmnt.options[j].innerHTML),
           c.addEventListener("click", function (e) {
               var t, i, n, o, s, r, a;
               for (r = (o = this.parentNode.parentNode.getElementsByTagName("select")[0]).length, s = this.parentNode.previousSibling, i = 0; i < r; i++)
                   if (o.options[i].innerHTML == this.innerHTML) {
                       for (o.selectedIndex = i, s.innerHTML = this.innerHTML, a = (t = this.parentNode.getElementsByClassName("same-as-selected")).length, n = 0; n < a; n++) t[n].removeAttribute("class");
...
function closeAllSelect(e) {
   var t,
       ...
       s,
       r = [];
   for (t = document.getElementsByClassName("select-items"), i = document.getElementsByClassName("select-selected"), o = t.length, s = i.length, n = 0; n < s; n++) e == i[n] ? r.push(n) : i[n].classList.remove("select-arrow-active");
   for (n = 0; n < o; n++) r.indexOf(n) && t[n].classList.add("select-hide");
}
       ...
       (e.cleanData = (function (t) {
           ...
           (e.widget = function (t, i, n) {
               ...
               return (
                   ...
                   e.extend(s, o, { version: n.version, _proto: e.extend({}, n), _childConstructors: [] }),
                   ...
                   (s.prototype = e.widget.extend(r, { widgetEventPrefix: (o && r.widgetEventPrefix) || t }, a, { constructor: s, namespace: l, widgetName: t, widgetFullName: c })),
                   o
           ...
           (e.widget.extend = function (t) {
               for (var n, o, s = i.call(arguments, 1), r = 0, a = s.length; a > r; r++)
                   for (n in s[r]) (o = s[r][n]), s[r].hasOwnProperty(n) && void 0 !== o && (t[n] = e.isPlainObject(o) ? (e.isPlainObject(t[n]) ? e.widget.extend({}, t[n], o) : e.widget.extend({}, o)) : o);
               return t;
           }),
                                     ...
                                     return "instance" === s
                                         ...
                                         ? e.isFunction(n[s]) && "_" !== s.charAt(0)
                                             ? (i = n[s].apply(n, a)) !== n && void 0 !== i
                                                 ...
                                                 : void 0
                                             : e.error("no such method '" + s + "' for " + t + " widget instance")
                                         : e.error("cannot call methods on " + t + " prior to initialization; attempted to call method '" + s + "'");
                                 })
                               : (l = void 0)
           ...
           (e.Widget.prototype = {
               ...
               _setOptionClasses: function (t) {
                   var i, n, o;
                   for (i in t) (o = this.classesElementLookup[i]), t[i] !== this.options.classes[i] && o && o.length && ((n = e(o.get())), this._removeClass(o, i), n.addClass(this._classes({ element: n, keys: i, classes: t, add: !0 })));
               },
               ...
               _trigger: function (t, i, n) {
                   var o,
                       s,
                       r = this.options[t];
                   if (((n = n || {}), ((i = e.Event(i)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase()), (i.target = this.element[0]), (s = i.originalEvent))) for (o in s) o in i || (i[o] = s[o]);
           ...
           e.each({ show: "fadeIn", hide: "fadeOut" }, function (t, i) {
               e.Widget.prototype["_" + t] = function (n, o, s) {
                   ...
                   var r,
                       a = o ? (!0 === o || "number" == typeof o ? i : o.effect || i) : t;
           ...
           e.widget("ui.slider", e.ui.mouse, {
               ...
               _createHandles: function () {
                   var t,
                       ...
                       s = [];
                   for (i = (n.values && n.values.length) || 1, o.length > i && (o.slice(i).remove(), (o = o.slice(0, i))), t = o.length; i > t; t++) s.push("<span tabindex='0'></span>");
               ...
               _mouseCapture: function (t) {
                   ...
                   return (
                       ...
                       this.handles.each(function (t) {
                           ...
                           (o > i || (o === i && (t === c._lastChangedValue || c.values(t) === d.min))) && ((o = i), (s = e(this)), (r = t));
                       }),
                       !1 !== this._start(t, r) &&
               ...
               _slide: function (e, t, i) {
                   var n,
                       o = this.value(),
                       s = this.values();
                   this._hasMultipleValues() && ((n = this.values(t ? 0 : 1)), (o = this.values(t)), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === t ? Math.min(n, i) : Math.max(n, i)), (s[t] = i)),
                             ...
                             (i = ((l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                                 ...
                                 !0 === l.options.range &&
                                     ("horizontal" === l.orientation
                                         ? (0 === n && l.range.stop(1, 1)[c ? "animate" : "css"]({ left: i + "%" }, a.animate), 1 === n && l.range[c ? "animate" : "css"]({ width: i - t + "%" }, { queue: !1, duration: a.animate }))
                                         : (0 === n && l.range.stop(1, 1)[c ? "animate" : "css"]({ bottom: i + "%" }, a.animate), 1 === n && l.range[c ? "animate" : "css"]({ height: i - t + "%" }, { queue: !1, duration: a.animate }))),
                                 (t = i);
                         })
                       : ((n = this.value()),
                         (o = this._valueMin()),
               ...
               _handleEvents: {
                   keydown: function (t) {
                       ...
                       switch (((o = this.options.step), (i = n = this._hasMultipleValues() ? this.values(s) : this.value()), t.keyCode)) {
                           case e.ui.keyCode.HOME:
                               n = this._valueMin();
                               break;
                           case e.ui.keyCode.END:
...
// Меняем фон карточки товара на градиент
// Маленькая библиотека RGBaster, которая помогает узнать преобладающий цвет с изображения
...
function changeBackgroundGradient(img){
   RGBaster.colors(img, {
      exclude: ['rgb(255,255,255)'],
      success: function(payload) {
         // payload.dominant = Преобладающий цвет

        // Устанавливаем фоновый цвет равный самому популярному.
        if (document.querySelector('.squad-header')){
         document.querySelector('.squad-header').style.background = `linear-gradient(180deg,  ${payload.dominant} 5%, rgb(0,0,0) 100%`;
        }      
      }
    });
}
if (document.querySelector('.squad-header-content__img')){
    let bgImageSrc = document.querySelector('.squad-header-content__img');
    changeBackgroundGradient(bgImageSrc.src);
}


// анимация добавления в корзину

// Вешаем прослушиватель на все вариации кнопки "купить"
if(document.querySelectorAll('.product-item-top__btn-basket')){
    const buttons = document.querySelectorAll('.product-item-top__btn-basket');
    buttons.forEach(button => button.addEventListener("click", function(e){
        const game = button.closest('.product-item');
        const gamePhoto = game.querySelector('.product-item-top__link-img');
        addToCart(button, gamePhoto);
    }));
}
if(document.querySelectorAll('.squad-header-content-box__buttons-add')){
    const buttons = document.querySelectorAll('.squad-header-content-box__buttons-add');
    buttons.forEach(button => button.addEventListener("click", function(e){
        const gamePhoto = document.querySelector('.squad-header-content__img');
        addToCart(button, gamePhoto);
    }));
}
if(document.querySelectorAll('.product-item-bottom-btns__basket')){
    const buttons = document.querySelectorAll('.product-item-bottom-btns__basket');
    buttons.forEach(button => button.addEventListener("click", function(e){
        const game = button.closest('.product-item');
        const gamePhoto = game.querySelector('.product-item-top__link-img');
        addToCart(button, gamePhoto);
...
if(document.querySelectorAll('.buying-block-top__price-basket')){
    const buttons = document.querySelectorAll('.buying-block-top__price-basket');
    buttons.forEach(button => button.addEventListener("click", function(e){
        const gamePhoto = document.querySelectorAll('.squad-header-content__img')[1];
        addToCart(button, gamePhoto);
    }));
}
// Функция которая добавляет товар в корзину, в нее нужно передать кнопку и картинку товара
function addToCart(cartButton, gamePhoto){
    console.log(cartButton);
    cartButton.classList.add('flying');

    const cart = document.querySelector('.header-bottom__box-basket');
    const cartText = cart.querySelector('span');

    const game = cartButton.closest('.product-item');
    const gameImageFly = gamePhoto.cloneNode(true);

    const gameImageFlyWidth = gamePhoto.offsetWidth;
    const gameImageFlyHeight = gamePhoto.offsetHeight;
    const gameImageFlyTop = gamePhoto.getBoundingClientRect().top;
    const gameImageFlyLeft = gamePhoto.getBoundingClientRect().left;

    gameImageFly.setAttribute('class', 'flyImage');
    gameImageFly.style.cssText = 
    `left: ${gameImageFlyLeft}px;
     top: ${gameImageFlyTop}px;
     width: ${gameImageFlyWidth}px;
     height: ${gameImageFlyHeight}px;`

    document.body.append(gameImageFly);
    ...
    function updateCart(){
        gameImageFly.remove();
        // cartText.innerHTML = `${parseInt(cartText.innerText) + 1}`;
        cartButton.classList.remove('flying');
    }
}

// Прячем шапку при скролле
let header;
if(document.querySelector('.squad-header__inner')) { header = document.querySelector('.squad-header__inner');  }else { header = document.querySelector('.header');  }

window.addEventListener("scroll", () => {
    let t = window.pageYOffset;

    if (window.screen.width <= 1000 || document.querySelector('.menu--active')) return;

    if(t>1){
     header.style.transform = `translate(0px, -${header.querySelector('.container').offsetHeight + 5}px)`;
    }else{
     header.querySelector('.header-bottom__inner').style.padding = '0px 0px 25px 0px';
    }
});


// адаптируем слайдер с главной под Firefox
...
if (browserName == 'firefox'){
    new Swiper(".index-top-swiper", {
        ...
        slidesPerView: 1.49,
        centeredSlides: !0,
        navigation: { prevEl: ".index-top-swiper-button-prev", nextEl: ".index-top-swiper-button-next" },
        pagination: { el: ".index-top-swiper-pagination", clickable: !0 },
        breakpoints: {
            300: { slidesPerView: 1, spaceBetween: 20, navigation: { enabled: !1, prevEl: ".index-top-swiper-button-prev", nextEl: ".index-top-swiper-button-next" } },
            551: { spaceBetween: 0, slidesPerView: 1 },
            1501: { slidesPerView: 1, navigation: { enabled: !0, prevEl: ".index-top-swiper-button-prev", nextEl: ".index-top-swiper-button-next" } },
            1611: { slidesPerView: 1.2 },
            1651: { slidesPerView: 1.25 },
            1701: { slidesPerView: 1.3 },
            1751: { slidesPerView: 1.35 },
            1801: { slidesPerView: 1.4 },
            1871: { slidesPerView: 1.49 },
            1921: { slidesPerView: 1.49 },
            1951: { slidesPerView: 1.5 },
            2001: { slidesPerView: 1.53 },
            2051: { slidesPerView: 1.58 },
            2101: { slidesPerView: 1.6 },
            2151: { slidesPerView: 1.63 },
            2201: { slidesPerView: 1.7 },
            2251: { slidesPerView: 1.75 },
            2301: { slidesPerView: 1.78 },
            2351: { slidesPerView: 1.82 },
            2401: { slidesPerView: 1.86 },
            2451: { slidesPerView: 1.9 },
            2501: { slidesPerView: 1.95 },
            2601: { slidesPerView: 1.98 },
            2651: { slidesPerView: 2 },
            2701: { slidesPerView: 2.03 },
            2751: { slidesPerView: 2.08 },
            2801: { slidesPerView: 2.1 },
            2851: { slidesPerView: 2.2 },
            2901: { slidesPerView: 2.25 },
            2951: { slidesPerView: 2.3 },
            3001: { slidesPerView: 2.33 },
            3051: { slidesPerView: 2.37 },
            3101: { slidesPerView: 2.4 },
            3151: { slidesPerView: 2.44 },
            3201: { slidesPerView: 2.48 },
            3251: { slidesPerView: 2.5 },
            3301: { slidesPerView: 2.54 },
            3351: { slidesPerView: 2.58 },
            3401: { slidesPerView: 2.62 },
            3451: { slidesPerView: 2.64 },
            3501: { slidesPerView: 2.7 },
            3601: { slidesPerView: 2.74 },
            3651: { slidesPerView: 2.78 },
            3701: { slidesPerView: 2.82 },
            3751: { slidesPerView: 2.84 },
            3801: { slidesPerView: 2.86 },
            3851: { slidesPerView: 2.88 },
            3901: { slidesPerView: 2.92 },
            3951: { slidesPerView: 2.96 },
            4001: { slidesPerView: 3 },
        },
    });
    ...
    breakpoints: {
        ...
        551: { spaceBetween: 0, slidesPerView: 1 },
        1501: { slidesPerView: 1., navigation: { enabled: !0, prevEl: ".index-top-swiper-button-prev", nextEl: ".index-top-swiper-button-next" } },
        1651: { slidesPerView: 1.2 },
        1701: { slidesPerView: 1.45 },
        1751: { slidesPerView: 1.45 },
        1801: { slidesPerView: 1.5 },
        1871: { slidesPerView: 1.6 },
        1921: { slidesPerView: 1.65 },
        1951: { slidesPerView: 1.7 },
        2001: { slidesPerView: 1.73 },
        2051: { slidesPerView: 1.78 },
        2101: { slidesPerView: 1.8 },
        2151: { slidesPerView: 1.83 },
        2201: { slidesPerView: 1.87 },
        2251: { slidesPerView: 1.9 },
        2301: { slidesPerView: 1.95 },
        2351: { slidesPerView: 2 },
        2401: { slidesPerView: 2.05 },
        2451: { slidesPerView: 2.07 },
        2501: { slidesPerView: 2.1 },
        2601: { slidesPerView: 2.14 },
        2651: { slidesPerView: 2.18 },
        2701: { slidesPerView: 2.22 },
        2751: { slidesPerView: 2.25 },
        2801: { slidesPerView: 2.28 },
        2851: { slidesPerView: 2.33 },
        2901: { slidesPerView: 2.37 },
        2951: { slidesPerView: 2.4 },
        3001: { slidesPerView: 2.45 },
        3051: { slidesPerView: 2.5 },
        3101: { slidesPerView: 2.55 },
        3151: { slidesPerView: 2.6 },
        3201: { slidesPerView: 2.63 },
        3251: { slidesPerView: 2.67 },
        3301: { slidesPerView: 2.7 },
        3351: { slidesPerView: 2.73 },
        3401: { slidesPerView: 2.77 },
        3451: { slidesPerView: 2.8 },
        3501: { slidesPerView: 2.83 },
        3601: { slidesPerView: 2.88 },
        3651: { slidesPerView: 2.92 },
        3701: { slidesPerView: 2.95 },
        3751: { slidesPerView: 2.97 },
        3801: { slidesPerView: 3 },
        3851: { slidesPerView: 3.05 },
        4001: { slidesPerView: 3 },
    },
...
if (document.querySelectorAll('.product-item-top__btn-favorite') || document.querySelectorAll('.squad-header-content-box__buttons-favorite') || document.querySelectorAll(".basket-body-content-item__bottom-favorite")){

    document.querySelectorAll('.product-item-top__btn-favorite').forEach(button => button.addEventListener("click", function(e){ addToFavourites(button) }) );
    document.querySelectorAll('.squad-header-content-box__buttons-favorite').forEach(button => button.addEventListener("click", function(e){ addToFavourites(button) }) );
    document.querySelectorAll('.basket-body-content-item__bottom-favorite').forEach(button => button.addEventListener("click", function(e){ addToFavourites(button) }) );
}

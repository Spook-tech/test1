...
if (
   ...
   $(function () {
       $(".header-top-lang").on("click", function (e) {
           ...
           $(".header-bottom__btn").on("click", function (e) {
            ...
            //    $(".header-top").removeClass("hideHeader");
           }),
   ...
   if (window.innerWidth > 1e3) {
       ...
       const headerTop = header.querySelector('.container');
       const headerTopHeight = header.querySelector('.container').offsetHeight;
       window.addEventListener("scroll", () => {
        ...
        //    if(t>1){
        //     headerTop.classList.add('hideHeader');
        //     // document.querySelector('.wrapper').style.margin = `50px 0px 0px 0px`;
        //    }else{
        //     headerTop.classList.remove('hideHeader');

        //     document.querySelector('.wrapper').style.margin = `0px 0px 0px 0px`;
...
if (window.screen.width <= 700 && document.querySelector('.squad-header-content__img')){
...
function addToCart(cartButton, gamePhoto){
    ...
    gameImageFly.addEventListener('transitionend', function(){
        if(cartButton.classList.contains('flying')){
            gameImageFly.remove();

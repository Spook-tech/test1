...
if(document.querySelectorAll('.buying-section-body-list-content-box__buttons-buy')){
    const buttons = document.querySelectorAll('.buying-section-body-list-content-box__buttons-buy');
    buttons.forEach(button => button.addEventListener("click", function(e){
        const game = button.closest('.buying-section-body-list__item');
        const gamePhoto = game.querySelector('.buying-section-body-list-top__img');
        addToCart(button, gamePhoto);
    }));
}
